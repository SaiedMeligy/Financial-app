...
class AllPatientRepositoryImp implements AllPatientRepository{
  ...
  @override
  Future<Response> getAllPatient(AllPatientModel patientModel, {int page = 1, int per_page = 20,String searchQuery=''}) async {
    try {
      final response = await dataSource.getAllPatients(patientModel,page: page,per_page: per_page,searchQuery:searchQuery);
