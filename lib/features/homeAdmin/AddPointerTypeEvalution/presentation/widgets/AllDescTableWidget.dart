...
class AllDescTableWidget extends StatelessWidget {
  List<DescImprovement> allDescImprovement = [] ;
  AllDescTableWidget({super.key , required this.allDescImprovement});
  int maxLength = 0 ;
  @override
            ...
            children: [
              ...
              for(int i = 0 ; i < maxLength ; i++)...[
                TableCellWidget(
                  padding: EdgeInsets.all(10),
                  child: TextWidget(
                    text: descImprovement.sessionAverages[i+1] == null ? "" : descImprovement.sessionAverages[i+1].toString() ,
                  )
                ),
              ],
              TableCellWidget(
                padding: EdgeInsets.all(10),
                child: TextWidget(
                  text: getEhanceState(descImprovement.sessionAverages),
                )
              ),
            ]
          );
