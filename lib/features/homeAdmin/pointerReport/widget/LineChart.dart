...
//                             fontWeight: FontWeight.bold,
//                           ),
//                           labelRotation: 90, // Rotate the labels to be vertical
//                         ),
//                         primaryYAxis: NumericAxis(
//                           labelStyle: Constants.theme.textTheme.bodySmall,
//                           minimum: 0,
//                           maximum: 100,
//                           isVisible: true, // Ensure Y-axis line is visible
//                           axisLine: AxisLine(
//                             width: 2,
//                             color: Colors.black,
//                           ),
//                           majorTickLines: MajorTickLines(width: 1), // Adjust tick lines as needed
//                           majorGridLines: MajorGridLines(width: 1), // Adjust grid lines as needed
//                         ),
//                         plotAreaBorderWidth: 0, // Remove the border of the plot area to give more space
//                         margin: EdgeInsets.all(20), // Add margin to ensure space for axis labels
//                         series: <ColumnSeries<PointerData, String>>[
//                           ColumnSeries<PointerData, String>(
//                             dataSource: countData,
//                             xValueMapper: (PointerData data, _) => data.patiens,
//                             yValueMapper: (PointerData data, _) => data.percentage,
//                             pointColorMapper: (PointerData data, _) => data.color,
//                           ),
//                         ],
//                         annotations: <CartesianChartAnnotation>[
//                           for (var data in countData)
