...
class SessionDetailsViewAdmin extends StatefulWidget {
  ...
  SessionDetailsViewAdmin({super.key, required this.pationt_data,required this.sessionId,required this.isFinished,required this.sessionCaseManager,required this.sessionComment,required this.sessionDate,required this.consultationService});
