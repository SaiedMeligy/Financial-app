...
class PatientNoNeedOtherSessionView extends StatefulWidget {
  const PatientNoNeedOtherSessionView({super.key});

  @override
  State<PatientNoNeedOtherSessionView> createState() => _PatientNoNeedOtherSessionViewState();
}

class _PatientNoNeedOtherSessionViewState extends State<PatientNoNeedOtherSessionView> {
  ...
  void initState() {
    ...
    allPatientCubit.getAllPatientWithAdminNoNeedOtherSession();
