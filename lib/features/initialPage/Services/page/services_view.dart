                      ...
                      children: [
                        ...
                        BlocBuilder<AddServiceCubit,AddServiceStates>(
                          ...
                          children: [
                            ...
                            child:Text( "اضافة خدمة",style: (Constants.mediaQuery.width < 600)?Constants.theme.textTheme.bodySmall:Constants.theme.textTheme.bodyLarge,),style: ElevatedButton.styleFrom(backgroundColor: Constants.theme.primaryColor,padding: EdgeInsets.all(20)),)
                                        ...
                                        child: Center(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              (Constants.mediaQuery.width < 600)?SizedBox(height: 10,):SizedBox(height: 70,),
                                              Row(
