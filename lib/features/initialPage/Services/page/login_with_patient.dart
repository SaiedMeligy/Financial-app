                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text('تسجيل الدخول باستخدام الهوية الرقمية',
                                      style: (Constants.mediaQuery.width < 600)?Constants.theme.textTheme.bodyMedium?.copyWith(color: Colors.black, ):Constants.theme.textTheme.titleLarge?.copyWith(color: Colors.black, fontSize: 28,)
                                      ,).setVerticalPadding(
